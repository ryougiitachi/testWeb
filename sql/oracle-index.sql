...
--过程
--索引的
CREATE UNIQUE INDEX IDX_TST_UQ_IDX_ID_FUN ON T_TST_UQ_IDX(DECODE(TST_ID, NULL, -1));
--约束的
CREATE UNIQUE INDEX IDX_TST_UQ_CON_ID_FUN ON T_TST_UQ_CON(DECODE(TST_ID, NULL, -1));
